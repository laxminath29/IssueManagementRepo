...
public class NotificationService {
	...
	@Async
	public void sendEmail(MailRequest request, String fromEmail,  String toEmail)
...
//			protected PasswordAuthentication getPasswordAuthentication() {return new PasswordAuthentication(fromEmail, fromPassword);}});
		...
		if (request.getFilePath() != null) {
			email = createEmailWithAttachment(toEmail,fromEmail,request.getSubject(),request.getContent(),new File(request.getFilePath()) );
		}
		 email = createEmail(toEmail,fromEmail,request.getSubject(),request.getContent());
		 email.setSentDate(new Date());
		 email.addRecipient(javax.mail.Message.RecipientType.TO, new InternetAddress("laxminath@nxtlifetechnologies.com"));
		sendMessage(service,fromEmail,email);
	}
